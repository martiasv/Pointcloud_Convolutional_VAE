...
""" A ROS-node which has an action that can be called to scramble the different obstacles in a large environment. This node scrambles a less complex environment"""
