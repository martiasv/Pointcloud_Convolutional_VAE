...
""" This script defines the Convolutional Variational Autoencoder and its parameters. At every new training round, the script will save a summary of all the parameters to file.
It also overloads many TF methods for enabling custom functionality. This includes custom train steps and test steps."""
